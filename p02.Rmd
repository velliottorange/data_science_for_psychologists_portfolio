...
lighthouses_clean <- lighthouses_all %>%
  ...
  # ---- 6. Consolidate automated column ----
  mutate(
...
```{r lighthouse_RDS_file, include=FALSE}
# Create RDS file
