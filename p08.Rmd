...
```{r summary_statistics_and_lifespan_histogram, fig.width=14, fig.height=10}
...
```{r status_plot, fig.width=14, fig.height=10}
...
```{r interactive_map, fig.width=14, fig.height=10}
